const Header = () => {
    return ( 
        <div className="header">
          <img className="logo" src="https://cdn.sanity.io/images/2v5nba1d/production/367ca21af316bafc9e58979cc88ca6fbfcb820f6-380x89.webp" alt=""/>
          <div className="header-menu">
            <a className="menu-link is-active" href="#">Ads</a>
